...
export default function Services() {
  const services = [
    ...
    {
      title: "Sistemas",
      description: "Desenvolvimento de sistemas e APIs REST com Asp.Net Core, Python e Node.js. Experiência com gerenciamento e manipulação de bancos de dados SQL.",
