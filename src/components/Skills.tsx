...
export default function Skills() {
  const educations = [
    {
      name: "Formação em Análise e Desenvolvimento de Sistemas | Senac (2020 - 2024)",
    },
    {
      name: "Curso de C# COMPLETO 2020 Programação Orientada a Objetos + Projetos | Udemy",
    },
    {
      name: "ASP.Net Core: crie aplicações com C#, .NET, Entity Framework e LINQ | Alura",
    },
    {
      name: "Trilha React : Aprenda do básico ao avançado | Alura",
    },
  ];
      ...
      <div className="container mx-auto max-w-4xl p-4 py-12">
        <div className="relative mb-4 p-4 text-center">
          ...
          <p className="relative text-sm text-gray-700">
            FullStack Developer | React.js | TypeScript | JavaScript | .Net |
            Node.js | Python | SQL
          </p>
