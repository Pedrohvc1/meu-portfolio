...
export default function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 81 9.9442-3593",
      link: "https://wa.me/5581994423593?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "phvcavalcanti@gmail.com",
      link: "mailto:phvcavalcanti@gmail.com?subject=Olá...",
      icon: <HiOutlineEnvelope className="h-10 w-10" />,
    },
    {
      name: "Jaboatão dos Guararapes, PE",
      description: "Via Local V",
      link: "https://www.google.com.br/maps/place/Via+Local+V+-+Santana,+Jaboat%C3%A3o+dos+Guararapes+-+PE/@-8.1105456,-35.0002545,17z/data=!3m1!4b1!4m6!3m5!1s0x7ab1d08eb0e380d:0xdcd47d6a1f101dcb!8m2!3d-8.1105509!4d-34.9976796!16s%2Fg%2F11j0s5kv2h?entry=ttu",
