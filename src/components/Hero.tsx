        ...
        <div className="container mx-auto flex max-w-4xl flex-col-reverse p-4 py-12 md:flex-row">
          <div className="basis-1/2">
            ...
            <p className="mb-6 text-center text-gray-400 md:text-left">
              Desenvolvedor Full Stack com especialização em C# e React,
              dedicado a transformar conceitos criativos em soluções inovadoras
              e eficazes!
            </p>
            ...
            <div className="flex items-center justify-center gap-2 md:justify-start">
              ...
              <a
                href="/public/Currículo Pedro Henrique Vieira Cavalcanti.pdf"
                target="_blank"
